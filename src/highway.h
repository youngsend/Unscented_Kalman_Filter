...
public:
    ...
    Highway(pcl::visualization::PCLVisualizer::Ptr& viewer)
    {
        ...
        egoCar = Car(Vect3(0, 0, 0), Vect3(4, 2, 2),
                     Color(0, 1, 0), 0, 0, 2, "egoCar");

        Car car1(Vect3(-10, 4, 0), Vect3(4, 2, 2),
                 Color(0, 0, 1), 5, 0, 2, "car1");
        ...
        Car car2(Vect3(25, -4, 0), Vect3(4, 2, 2),
                 Color(0, 0, 1), -6, 0, 2, "car2");
        ...
        Car car3(Vect3(-12, 0, 0), Vect3(4, 2, 2),
                 Color(0, 0, 1), 1, 0, 2, "car3");
        ...
        if(!pass)
        {
            ...
            if(rmseFailLog[1] > 0)
                viewer->addText(" Y: "+std::to_string(rmseFailLog[1]), 30, 100, 20, 1,
                                0, 0, "rmse_fail_y");
            if(rmseFailLog[2] > 0)
                viewer->addText("Vx: "+std::to_string(rmseFailLog[2]), 30, 75, 20, 1,
                                0, 0, "rmse_fail_vx");
            if(rmseFailLog[3] > 0)
                viewer->addText("Vy: "+std::to_string(rmseFailLog[3]), 30, 50, 20, 1,
                                0, 0, "rmse_fail_vy");
        }
